# Eksam Moodul 2 - AI-pildid

Moodul 2 sisaldab Slow Pour veebilehe AI-pildimaterjali.

Taaniel Vananurm MM-23

## Sisu

- `original/` - algsed PNG pildid
- `optimized/` - WebP ja AVIF versioonid veebikasutuseks
- `promptid.md` - promptid, tööriist ja failide kirjeldus
- `docs/labipaistvus-ja-litsents.md` - AI kasutuse ja optimeerimise märkus
...
| `original/Dark Roast.png` | `optimized/dark-roast.webp` | `optimized/dark-roast.avif` | Kohvisordi pilt |
| `original/Popular Roast.png` | `optimized/popular-roast.webp` | `optimized/popular-roast.avif` | Populaarse kohvisordi pilt |
